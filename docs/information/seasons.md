...
<p align="center" width="100%">
    <img width="66%" src="https://i.imgur.com/2IHWWQj.png">
</p>
...
## Selling Season XP (VIP/VIP+ Only)
VIP users are able to sell a portion of their XP back for different rewards once you've completed the Season pass.

- VIP users cannot go below 1.5m XP
- VIP+ users cannot go below 8m XP

<p align="center" width="100%">
    <img width="44%" src="https://i.imgur.com/G34uGIh.png">
</p>

You're able to sell XP back for Cash, Bullets, Points or Epic Crates.
